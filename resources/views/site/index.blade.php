    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <table class="table text-center" id="sitesTable">
                    <thead>
                    <tr>
                    ...
                    @foreach($sites as $site)
                        ...
                        <tr class='clickable-row' data-href="{{route('sensors' ,  $site->id)}}">
                            ...
                            @if(Auth::user()->usertype->Description == "ResponsabileAziendale")
                                <td>
                                    <p data-placement="top" data-toggle="tooltip" title="Modifica"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#editSiteModal" id="{{ $site->id }} | {{ $site->Name }} | {{ $site->Description }}"><span class="glyphicon glyphicon-pencil"></span></button></p>
                                </td>
                                <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    <button type="button" class="btn btn-warning btn-lg" style="width: 100%;"><span class="glyphicon glyphicon-ok-sign"></span> Aggiorna</button>
                </div>
            </div>
        </div>
    </div>
